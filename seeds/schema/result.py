...
class SeedCardResult(BaseModel):
    ...
    Attributes: card_id (str): Уникальный идентификатор карты.
    """
    card_id: str
...
class SeedOperationResult(BaseModel):
    ...
    Attributes: operation_id (str): Уникальный идентификатор операции.
    """
    operation_id: str
...
class SeedsResult(BaseModel):
    ...
    Attributes: users (list[SeedUserResult]): Список сгенерированных пользователей.
    """
    ...
    def get_next_user(self) -> SeedUserResult:
        ...
        Returns: SeedUserResult: Следующий пользователь из списка.
        """
    ...
    def get_random_user(self) -> SeedUserResult:
        ...
        Returns: SeedUserResult: Случайный пользователь.
        """
