...
class SeedsBuilder:
    ...
    def build_savings_account_result(self, user_id: str) -> SeedAccountResult:
        ...
        Args: user_id: Идентификатор пользователя
        Returns: SeedAccountResult: Результат с ID созданного счёта
        """
    ...
    def build_user(self, plan: SeedUsersPlan) -> SeedUserResult:
        ...
        Args: plan: План генерации пользователя
        Returns: SeedUserResult: Результат с ID пользователя и всеми созданными сущностями
        """
    ...
    def build(self, plan: SeedsPlan) -> SeedsResult:
        ...
        Args: plan: Полный план генерации данных
        Returns: SeedsResult: Результат с данными всех созданных пользователей
        """
...
def build_grpc_seeds_builder() -> SeedsBuilder:
    ...
    Returns: SeedsBuilder: Инициализированный сидер с gRPC-клиентами
    """
    return SeedsBuilder(
...
def build_http_seeds_builder():
    ...
    Returns: SeedsBuilder: Инициализированный сидер с HTTP-клиентами
    """
    return SeedsBuilder(
